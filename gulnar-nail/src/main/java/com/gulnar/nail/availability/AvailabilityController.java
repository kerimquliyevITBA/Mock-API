...
public class AvailabilityController {
    ...
    public record TimeReq(@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "HH:mm") LocalTime time) {}
    ...
    public ResponseEntity<?> addSlot(
        ...
        return ResponseEntity.ok(new AvailabilityDto.SlotView(s.getSlotTime(), false, false));
    }
